...
export default function Features({ slug }: AppsProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-12 bg-gray-50 h-screen">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {features.map((feature) => (
          <Card key={feature.id} className="overflow-hidden border border-gray-200 transition-colors duration-300 hover:border-gray-300">
            ...
            <CardFooter className="px-6 pb-6 pt-0">
              <Button
                ...
                onClick={() => feature.isLive && router.push(`/dashboard/${feature.path}/${slug}`)}
              >
